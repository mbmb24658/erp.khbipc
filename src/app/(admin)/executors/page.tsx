...
export default function ExecutorsPage() {
  ...
  const fields: FormField[] = [
    {
      ...
      required: true,
      readOnly: true,
      helpText: "کد مجری به‌صورت خودکار تولید می‌شود",
    },
  ...
  const handleSave = async (formData: Record<string, any>) => {
    // Code is auto-generated by the API on create; on edit it stays read-only.
  ...
  const openAdd = async () => {
    ...
    setPresetCode("");
    try {
      const res = await fetch("/api/executor/next-code");
  ...
  return (
    <div>
      ...
      <EditDialog
        ...
        fields={fields}
        initialData={editing || { type: "شرکت", code: presetCode }}
        onSubmit={handleSave}
      />
